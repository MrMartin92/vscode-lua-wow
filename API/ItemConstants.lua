...
enum.InventoryType.IndexTrinketType = 12
enum.InventoryType.IndexWeaponType = 13
enum.InventoryType.IndexShieldType = 14
enum.InventoryType.IndexRangedType = 15
enum.InventoryType.IndexCloakType = 16
enum.InventoryType.Index2HweaponType = 17
enum.InventoryType.IndexBagType = 18
enum.InventoryType.IndexTabardType = 19
enum.InventoryType.IndexRobeType = 20
enum.InventoryType.IndexWeaponmainhandType = 21
enum.InventoryType.IndexWeaponoffhandType = 22
enum.InventoryType.IndexHoldableType = 23
enum.InventoryType.IndexAmmoType = 24
enum.InventoryType.IndexThrownType = 25
enum.InventoryType.IndexRangedrightType = 26
enum.InventoryType.IndexQuiverType = 27
enum.InventoryType.IndexRelicType = 28


---@alias ItemQuality number|"enum.ItemQuality.Poor"|"enum.ItemQuality.Common"|"enum.ItemQuality.Uncommon"|"enum.ItemQuality.Rare"|"enum.ItemQuality.Epic"|"enum.ItemQuality.Legendary"|"enum.ItemQuality.Artifact"|"enum.ItemQuality.Heirloom"|"enum.ItemQuality.WoWToken"
